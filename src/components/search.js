...
const Search = ({searchResults, setSearchResults, setLoadingData, setQuoteValues, setInputValues, setInputsByCategory, setInputValues2}) => {
    ...
    const  handleSubmit = (e) => {
        e.preventDefault();
        searchAddress({address: searchText, state: selectedState}, setSearchResults);
    }
    ...
    return (
        <Form initialValues={{}} onSubmit={handleSubmit}>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={2}>
                    <Button type="submit" disabled={selectedState && searchText ? false : true} variant="outlined" onClick={handleSubmit}>
                        Search
                    </Button>
                </Grid>
